...
{
    /// <inheritdoc />
    public partial class ImrpoveStatusesAndAddMoreRowsToList : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlannedShoppingDate = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShoppingLists_ProductStatuses_SourceId",
                        column: x => x.SourceId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingLists_SourceId",
                table: "ShoppingLists",
                column: "SourceId");
